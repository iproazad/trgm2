...
export class AppComponent {
  ...
  async handleTranslation(): Promise<void> {
    ...
    try {
      ...
      const errorMessage = e instanceof Error ? e.message : 'حدث خطأ أثناء الترجمة. يرجى المحاولة مرة أخرى.';
  ...
  async handleSpellCheck(): Promise<void> {
    ...
    try {
      ...
      const errorMessage = e instanceof Error ? e.message : 'حدث خطأ أثناء التدقيق الإملائي. يرجى المحاولة مرة أخرى.';
      this.error.set(errorMessage);
      console.error(e);
    } finally {
